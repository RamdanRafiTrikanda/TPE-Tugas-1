...
$id=$_GET['id'];
$queryEdit=mysqli_query($koneksi, "SELECT * FROM tbl_produk WHERE id_produk='$id'");
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                include "../../lib/koneksi.php";
                $id= $_GET['id'];
                $QueriProduk = mysqli_query($koneksi, "SELECT * FROM tbl_produk WHERE id_produk='$id'");
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id_produk" value="<?php echo $id; ?>">
                        ...
                        <div class="form-group">
                        <label>Gambar</label>
                        <input type="hidden" name="id" value="<?php echo $q['gambar']; ?>">
                        <input type="file" class="form-control" name="gambar" value="<?= $q['gambar']; ?>">
                        </div>
