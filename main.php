...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="myaccount.php" class="get-started-btn">MyAccount</a>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1><center>Partner Kesehatan Lansia dan Keluarga</center></h1>
      <h2><center>Menuju Paruh Baya yang Berdaya</center></h2>
      <h2><center><b><i>"Get Older Get Stronger!"</i></b></h2></center>
      <center><a href="register.php" class="btn-get-started">Daftar Sekarang</a></center>
    </div>
  </section><!-- End Hero -->
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
          ...
          <td><img src="<?= $baseUrl; ?>admin/pages/produk/foto/<?=$r['gambar']; ?>"height="200" width="280"></td>
            <div class="course-content">
              ...
              <strong><span><i class="bx bx-receipt"> Sertifikat</span></strong></i>
              <span></span>  <span></span> <span></span>  <span></span>
              <span><i class="bx bx-chat"> Konsultasi</span></i>
              </div>
              </div>
              <div class="trainer d-flex justify-content-between align-items-center">
                <div class="trainer-profile d-flex align-items-center">
  ...
  <section id="popular-courses" class="courses">
    <div class="container" data-aos="fade-up">
      ...
      $q = mysqli_query ($koneksi, "SELECT * FROM tbl_produk ORDER BY id_produk desc limit 4");
      while ($r=mysqli_fetch_array($q)){
              ...
              <div class="row">
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Belajar dari Para Professional</h4>
